...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    /**
     * assigned global templates vars
     */
    ...
    public function __construct()
    {
        ...
        $this->debug_tpl = 'file:' . dirname(__FILE__) . '/debug.templates';
     ...
     */
    public function compileAllTemplates($extension = '.templates', $force_compile = false, $time_limit = 0, $max_errors = null)
    {
